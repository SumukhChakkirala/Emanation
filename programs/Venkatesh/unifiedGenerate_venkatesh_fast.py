...
def save_dataset_info(
    ...
    with open(info_path, 'w') as fh:
        ...
        fh.write("  7. Compute IFFT of padded complex signal\n")
...
Examples:
  Decimated mode, all cases:
    python unifiedGenerate_venkatesh_fast.py --case ALL

  No-decimation (OR) mode, Case 3 f_h range:
    python unifiedGenerate_venkatesh_fast.py --case 3 --no_decimation

  No-decimation, all cases, GPU backend:
    python unifiedGenerate_venkatesh_fast.py --case ALL --no_decimation --backend gpu
