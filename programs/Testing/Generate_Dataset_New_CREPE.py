...
# =============================================================================
# Dataset Generation - FIXED VERSION (includes all 360 bins)
# =============================================================================
...
def generate_crepe_dataset_dense(
    ...
    for bin_idx in bins_to_generate:
        ...
        # FIX: Use 5% tolerance on both ends to include edge bins (0,1,2,358,359)
        if F_h < CREPE_FMIN * 0.95 or F_h > CREPE_FMAX * 1.05:
            continue
    ...
    print(f"  Missing bins: {[b for b in range(360) if b not in bins]}")
...
if __name__ == "__main__":
    ...
    # Generate ALL 360 bins
    bins_to_generate = list(range(0, 360))
